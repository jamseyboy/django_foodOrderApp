...
This project is pre-configured for **Railway** (`railway.toml` + `Dockerfile`). See (https://github.com/jamseyboy/django_foodOrderApp/blob/main/RAILWAY_DEPLOYMENT_GUIDE.md)** for the full step-by-step guide covering both this backend and the Next.js frontend.
